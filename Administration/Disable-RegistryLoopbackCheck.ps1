...
.EXAMPLE
    ...
    Overwrites the existing BackConnectionHostNames with "pm.dev.local" and "intranet.dev.local".
.EXAMPLE
    Disable-RegistryLoopbackCheck.ps1 -BackConnectionHostNames ("pm.dev.local","intranet.dev.local") -UpdateBackConnectionHostNames
    Adds the BackConnectionHostNames for "pm.dev.local" and "intranet.dev.local".
.EXAMPLE
    Disable-RegistryLoopbackCheck.ps1 -DisableLoopbackCheck
    Disables the LoopbackCheck.
