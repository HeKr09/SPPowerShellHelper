...
.EXAMPLE
    ...
    Copies the latest major version of the item with ID 12 within the list SourceList to the list "Documents" within the web "http://test.dev.local".
.EXAMPLE
    ...
    Copies the major version 7.0 of the item with ID 12 within the list SourceList to the list "Documents" within the web "http://test.dev.local".
.PARAMETER WebUrl
    The url of the web.
