...
.EXAMPLE
    ...
    Sets the url "/subWeb/SiteAssets/custom.css" as alternate css url of the web "http://test.dev.local/subweb".
.EXAMPLE
    Set-SPAlternateCssUrl.ps1 -SiteUrl "http://test.dev.local" -CssUrl "/SiteAssets/custom.css"
    Sets the url "/subWeb/SiteAssets/custom.css" as alternate css url of the all webs within the site collection "http://test.dev.local".
.PARAMETER WebUrl
