...
.EXAMPLE
    Duplicate-SPEnterpriseSearchComponents.ps1 -IndexRootDirectory "D:\SP-Search\INDEX" -ServerToDuplicateComponents "TSP7AP001" -SearchServiceName "SSA"
.EXAMPLE
    Duplicate-SPEnterpriseSearchComponents.ps1 -IndexRootDirectory "D:\SP-Search\INDEX" -ServerToDuplicateComponents "TSP7AP001" -SearchServiceName "SSA" -IndexPartition 1
